 ...
 */
@interface AFNMoatNativeDisplayTracker : AFNMoatBaseTracker
 ...
 * @return AFNMoatNativeDisplayTracker instance
 */
+ (AFNMoatNativeDisplayTracker *)trackerWithAdView:(UIView *)adView withAdIds:(NSDictionary *)adIds;
