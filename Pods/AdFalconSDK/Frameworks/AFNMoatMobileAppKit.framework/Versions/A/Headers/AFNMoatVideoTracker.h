...
#import "AFNMoatBaseTracker.h"

/** Tracker for tracking native video ads shown with AVPlayer or MPMoviePlayerController.
 *
 * @warning This class will be removed in a future version of this SDK. We recommend using AFNMoatMPVideoTracker and AFNMoatAVVideoTracker instead of this class.
...
@interface AFNMoatVideoTracker : AFNMoatBaseTracker
 ...
 * @return AFNMoatVideoTracker instance
 */
+ (AFNMoatVideoTracker *)trackerWithPartnerCode:(NSString *)partnerCode;
