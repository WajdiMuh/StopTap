...
@interface AFNMoatOptions : NSObject<NSCopying>
...
@interface AFNMoatAnalytics : NSObject
 ...
 * @see AFNMoatOptions
 */
- (void)startWithOptions:(AFNMoatOptions *)options;
 ...
 * @see AFNMoatVideoTracker.h for more detail on what constitues a native ad.
 *
