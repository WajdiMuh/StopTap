...
#import "AFNMoatAdEvent.h"
#import "AFNMoatBaseVideoTracker.h"

typedef enum AFNMoatTrackerState : NSUInteger {
 ...
 *
 */
@interface AFNMoatReactiveVideoTracker : AFNMoatBaseVideoTracker

@property (assign, nonatomic, readonly) AFNMoatTrackerState state;
 ...
 *
 * @see AFNMoatAdEvent to see the required video ad events that must be reported to the SDK if they occur
 */
- (void)dispatchEvent:(AFNMoatAdEvent *)event;
