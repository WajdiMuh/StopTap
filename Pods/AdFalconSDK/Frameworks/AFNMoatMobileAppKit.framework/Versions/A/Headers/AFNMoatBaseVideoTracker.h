 ...
 */
@interface AFNMoatBaseVideoTracker : AFNMoatBaseTracker

- (id)init __unavailable;
+ (id)new __unavailable;

/**
 Delegate Property for AFNMoatBaseVideoTracker and its subclasses to have to report ad event firings.
 */
@property (weak, nonatomic) id<AFNMoatVideoTrackerDelegate> videoTrackerDelegate;
