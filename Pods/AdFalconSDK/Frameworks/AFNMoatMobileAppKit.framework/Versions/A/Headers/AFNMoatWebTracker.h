 ...
 */
@interface AFNMoatWebTracker : AFNMoatBaseTracker
 ...
 * @return AFNMoatWebTracker instance
 */
+ (AFNMoatWebTracker *)trackerWithWebComponent:(UIView *)webViewOrWebViewContainer;
...
+ (AFNMoatWebTracker *)trackerWithAdView:(UIView *)adView withWebComponent:(UIView *)webViewOrWebViewContainer;
