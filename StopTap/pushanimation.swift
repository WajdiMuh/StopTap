...
class pushanimation: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if(fromViewController?.title! == "Main" && toViewController?.title! == "Play"){
        transitionContext.containerView.addSubview((toViewController?.view)!)
        transitionContext.containerView.backgroundColor = UIColor.white
        toViewController?.view?.center.y = (toViewController?.view?.center.y)! / -1
        UIView.animate(withDuration: transitionDuration(using: transitionContext), delay: 0, options: [.curveEaseOut], animations: {() -> Void in
            ...
            fromViewController?.view?.center.y = (fromViewController?.view.center.y)! * 3
        }, completion: {(_ finished: Bool) -> Void in
            transitionContext.completeTransition(!transitionContext.transitionWasCancelled)
        })
        }
        if(fromViewController?.title! == "Main" && toViewController?.title! == "Htp"){
            transitionContext.containerView.addSubview((toViewController?.view)!)
            transitionContext.containerView.backgroundColor = UIColor.white
        ...
        if(fromViewController?.title! == "Main" && toViewController?.title! == "Shop"){
            transitionContext.containerView.addSubview((toViewController?.view)!)
            transitionContext.containerView.backgroundColor = UIColor.white
        ...
        if(fromViewController?.title! == "Main" && toViewController?.title! == "Settings"){
            transitionContext.containerView.addSubview((toViewController?.view)!)
        ...
        if(fromViewController?.title! == "Main" && toViewController?.title! == "Dev"){
            transitionContext.containerView.addSubview((toViewController?.view)!)
            if(KeyStoreDefaultsProvider(cryptoProvider: nil).getInt(forKey: "nm", defaultValue: 0) == 0){
                transitionContext.containerView.backgroundColor = UIColor.white
            }else{
        ...
        if(fromViewController?.title! == "Settings" && toViewController?.title! == "Language"){
            transitionContext.containerView.addSubview((toViewController?.view)!)
            if(KeyStoreDefaultsProvider(cryptoProvider: nil).getInt(forKey: "nm", defaultValue: 0) == 0){
                transitionContext.containerView.backgroundColor = UIColor.white
            }else{
